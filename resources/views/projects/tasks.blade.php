                        ...
                        <tbody>
                            @forelse ($tasks as $task)
                                <tr class="hover:bg-grey-lighter border-b border-secondary-gray">
                                    ...
                                    <td>
                                        <span
                                            class="{{ $task->status === 'done' ? 'bg-green-600' : ($task->status === 'not_done' ? 'bg-red-600' : 'bg-yellow-400') }} text-white px-2 py-0.5 text-xs rounded-full">
                                            {{ $task->status() }}
                                        </span>
                                    </td>
                                    <td class="py-4 px-6">
