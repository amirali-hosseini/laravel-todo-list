        ...
        <main class="w-full flex-grow">
            <div class="w-full p-3 mt-2">
                ...
                <div class="flex items-center justify-between mb-4">
                    <h1 class="w-full text-xl font-estedad-bold text-black pb-4">پروژه ها</h1>
                                ...
                                <tr class="hover:bg-grey-lighter border-b border-secondary-gray">
                                    ...
                                    <td class="py-4 px-6">
                                        <div class="flex items-center justify-center gap-3">
                                            <a href="{{ route('projects.tasks', $project) }}" class="text-lg text-purple-600">
                                            ...
                                            <a href="{{ route('projects.edit', $project) }}" class="text-lg text-yellow-400">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                    stroke-width="1.5" stroke="currentColor" class="size-6">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                            ...
                                            <form action="{{ route('projects.destroy', $project) }}" method="post"
                                                ...
                                                <button type="submit" class="text-lg text-red-600"
                                                    onclick="return confirm('آیا از حذف این پروژه اطمینان دارید ؟ تمامی تسک های مرتبط با این پروژه نیز حذف خواهد شد.')">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                        stroke-width="1.5" stroke="currentColor" class="size-6">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
