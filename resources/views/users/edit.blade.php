...
@section('content')
    <div class="w-full p-3">
        ...
        <div>
            <form class="p-4 bg-white rounded-lg" action="{{ route('users.update', $user->id) }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 my-4">
                    ...
                    <div class="">
                        ...
                        <select
                            ...
                            <option value="1" {{ old('is_admin', $user->isAdmin()) ? 'selected' : '' }}>ادمین</option>
                        </select>
                    </div>
                    <div class="">
                        ...
                        <select
                            ...
                            <option value="1" {{ old('email_verified', $user->hasVerifiedEmail()) ? 'selected' : '' }}>
                                تایید شده</option>
                        </select>
                    </div>
                </div>
